...
export default function UpdateProductAction() {
    ...
    return (
        <div ref={menuRef}>
            {/* Toggle Button */}
            <button className="font-medium text-blue-600 dark:text-blue-500 hover:underline" onClick={() => setMenuOpen(prev => !prev)} >Edit</button>
