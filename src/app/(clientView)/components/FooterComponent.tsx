            ...
            {/* <div className="relative z-40 lg:hidden" role="dialog" aria-modal="true">
                ...
                <div className="fixed inset-0 z-40 flex">
                    <div className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl">
                        ...
                        <div className="mt-2">
                            <div className="border-b border-gray-200">
                                <div className="-mb-px flex space-x-8 px-4" aria-orientation="horizontal" role="tablist">
                                    <button id="tabs-1-tab-1" className="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900" aria-controls="tabs-1-panel-1" role="tab" type="button">Women</button>
                                    <button id="tabs-1-tab-2" className="flex-1 border-b-2 border-transparent px-1 py-4 text-base font-medium whitespace-nowrap text-gray-900" aria-controls="tabs-1-panel-2" role="tab" type="button">Men</button>
                                </div>
                            </div>
                        ...
                        <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                            <div className="flow-root">
                                <a href="/auth/sign-in" className="-m-2 block p-2 font-medium text-gray-900">Sign in</a>
                            </div>
                            <div className="flow-root">
                        ...
                        <div className="flex h-16 items-center">
                                ...
                                <div className="flex h-full space-x-8">
                                    <div className="flex">
                                        <div className="relative flex">
                                            <button type="button" className="relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out hover:text-gray-800" aria-expanded="false">Women</button>
                                        </div>
                                        <div className="absolute inset-x-0 top-full text-sm text-gray-500">
                                            <div className="absolute inset-0 top-1/2 bg-white shadow-sm" aria-hidden="true"></div>
                                    ...
                                    <div className="flex">
                                        <div className="relative flex">
                                            <button type="button" className="relative z-10 -mb-px flex items-center border-b-2 border-transparent pt-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out hover:text-gray-800" aria-expanded="false">Men</button>
                                        </div>
                                                        ...
                                                        <div className="col-start-2 grid grid-cols-2 gap-x-8">
                                                            <div className="group relative text-base sm:text-sm">
                                                                <Link href="/shop" className="group block">
                                                                    <div className="relative">
                                                                        <Image
                                                                            src="/assets/mega-menu-category-01.jpg"
                                                                            alt="Product Image"
                                                                            width={1200}
                                                                            height={800}
                                                            ...
                                                            <div className="group relative text-base sm:text-sm">
                                                                <Link href="/shop" className="group block">
                                                                    <div className="relative">
                                                                        <Image
                                                                            src={`/assets/mega-menu-category-02.jpg`}
                                                                            alt="Product Image"
                                                                            width={1200}
                                                                            height={800}
                                                                            sizes="(max-width: 768px) 100vw, 50vw"
                                                                    ...
                                                                    <div className="mt-6">
                                                                        <p className="font-medium text-gray-900">Artwork Tees</p>
                                                                        <p aria-hidden="true" className="mt-1">Shop now</p>
                                                                    </div>
                                                                </Link>
                            ...
                            <div className="ml-auto flex items-center">
                                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                                    <Link href="/auth/sign-in" className="text-sm font-medium text-gray-700 hover:text-gray-800">Sign In</Link>
                                    <span className="h-6 w-px bg-gray-200" aria-hidden="true"></span>
                                    <Link href="/auth/sign-out" className="text-sm font-medium text-gray-700 hover:text-gray-800">Create account</Link>
                                </div>
